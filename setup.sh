...
heroku buildpacks:add -i 2 https://github.com/salesforceplatform/salesforce-buildpack -a $HEROKU_DEV_APP_NAME
heroku buildpacks:add -i 2 https://github.com/salesforceplatform/salesforce-buildpack -a $HEROKU_STAGING_APP_NAME
heroku buildpacks:add -i 2 https://github.com/salesforceplatform/salesforce-buildpack -a $HEROKU_PROD_APP_NAME
